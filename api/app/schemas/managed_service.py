...
class ManagedServiceCreate(BaseModel):
    ...
    db_name: str | None = Field(None, max_length=63, pattern=r"^[a-z][a-z0-9_]*$", description="Custom database name")
    db_user: str | None = Field(None, max_length=63, pattern=r"^[a-z][a-z0-9_]*$", description="Custom database user")
