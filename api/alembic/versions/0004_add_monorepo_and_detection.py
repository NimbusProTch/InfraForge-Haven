...
def upgrade() -> None:
    ...
    op.add_column("applications", sa.Column("resource_cpu_request", sa.String(32), server_default="50m", nullable=False))
    op.add_column("applications", sa.Column("resource_cpu_limit", sa.String(32), server_default="500m", nullable=False))
    op.add_column("applications", sa.Column("resource_memory_request", sa.String(32), server_default="64Mi", nullable=False))
    op.add_column("applications", sa.Column("resource_memory_limit", sa.String(32), server_default="512Mi", nullable=False))
