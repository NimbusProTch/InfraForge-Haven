...
export function ConnectedServicesPanel({
  ...
  async function handleDisconnect(serviceName: string) {
    ...
    try {
      await api.services.disconnectFromApp(tenantSlug, appSlug, serviceName, accessToken);
      onRefresh();
    } catch (err) {
      ...
      <div className="space-y-3">
        ...
        {connected.map((svc) => (
          <div
            ...
            className="flex items-start gap-3 p-3 rounded-lg border border-gray-100 dark:border-[#1e1e1e] bg-gray-50/50 dark:bg-[#0a0a0a]"
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              {showCredentials === svc.service_name && credentials && (
                <div className="mt-2 p-2 rounded bg-gray-100 dark:bg-[#1a1a1a] space-y-1">
            ...
            <div className="flex items-center gap-1 shrink-0">
              <button
                onClick={() => handleShowCredentials(svc.service_name)}
              ...
              <button
                onClick={() => handleDisconnect(svc.service_name)}
